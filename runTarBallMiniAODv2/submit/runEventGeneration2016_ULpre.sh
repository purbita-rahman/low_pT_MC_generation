...
#cmsDriver.py step2 --filein file:${outfilename}_gen.root --fileout file:${outfilename}_sim.root --mc --eventcontent RAWSIM --runUnscheduled --datatier GEN-SIM --conditions 106X_mcRun2_asymptotic_preVFP_v9 --beamspot Realistic25ns13TeV2016Collision --step SIM --nThreads 8 --geometry DB:Extended --era Run2_2016_HIPM --python_filename ${outfilename}_sim.py -n 9999 --no_exec 
#Run
...
#cmsDriver.py step6 --filein file:${outfilename}_RECO.root --fileout file:${outfilename}_miniaod.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v9 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2016_HIPM --python_filename ${outfilename}_miniaod_cfg.py  -n 9999 --no_exec
...
xrdcp  ${outfilename}_miniaod.root  root://cmseos.fnal.gov//store/group/lpcmetx/Monotop/Signal20UL16MiniAODv2/${dirname}/Monotop_${dirname}_${TempNumber}_miniaod.root
