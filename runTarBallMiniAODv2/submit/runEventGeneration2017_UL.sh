...
#xrdcp ${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/dxiong/030422production/MINIAOD/${dirname}/${outfilename}_miniaod.root
#xrdcp ${outfilename}_miniaod.root root://cmseos.fnal.gov//store/user/pprova/T5gg_production/g2200_X700_delm100/${outfilename}_miniaod.root
#xrdcp ${outfilename}_RECO.root root://cmseos.fnal.gov//store/user/pprova/T5gg_production/${outfilename}_RECO.root
#xrdcp ${outfilename}_RECO.root root://cmseos.fnal.gov//store/user/dxiong/030422production/RECO/${dirname}/${outfilename}_RECO.root
#xrdcp ${outfilename}_gensim.root root://cmseos.fnal.gov//store/user/dxiong/022822production/2017/GENSIM/${dirname}/${outfilename}_gensim.root
xrdcp ${outfilename}_gen.root root://cmseos.fnal.gov//store/user/pprova/T5gg_production/g2200_X700_delm100/${outfilename}_gen.root
